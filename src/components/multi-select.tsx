												...
												return (
													<Badge
														...
														<div
															...
															className="ml-2 h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50 h-full">
															<XCircle
																className={cn(
																	"h-3 w-3 ",
																	responsiveSettings.compactMode &&
										...
										{filteredOptions.map((option) => {
											...
											return (
												<CommandItem
													...
													<div
														className={cn(
															"mr-2 flex h-4 w-4 items-center justify-center rounded-sm border border-muted-foreground/60",
															isSelected
																? "bg-background  text-primary-foreground"
																: "opacity-50 [&_svg]:invisible"
														)}
